define([
	...
	'views/contacts',
	'services/api'
], function($, Q, _, Marionette, User, Contact, SignupForm, ContactForm, ContactsView, Api) {
	...
	var Controller = Marionette.Controller.extend({
		...
		newContact: function(){
			...
			newContactForm.on('form:submitted', function(attrs){
				...
				contact.set('avatar', Api.getAvatar(attrs.gender))
		...
		signupUser: function(){
			var model = new User() 
				signupForm = new SignupForm({ model: model })
				that = this;
